...
while powered_on:
    ...
    """
    userSelection = input(f"What would you like? ({main_menu.get_items()}): ").lower()
    ...
    if userSelection == "off":
        ...
        """
        selected_item = main_menu.find_drink(userSelection)
            ...
            if coffee_maker.is_resource_sufficient(selected_item):
                ...
                """
                    6. Check transaction successful?
                        ...
                        E.g. “Herre is $2.45 dollars in change.” The change should be rounded to 2 decimal places.
                """
